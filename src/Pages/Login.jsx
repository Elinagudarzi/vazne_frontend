...
export const Login = (props) => {
    ...
    return (
        ...
        <div className="login-div">
            ...
            <form style={{marginTop:"-0.5px"}} className="login-form" onSubmit={handleSubmit}>
            ...
            <Link to="/register" className="link-btn link-btn-hover" onClick={() => props.FormSwitch('register')}>آیا در وزنه اکانت ندارید؟ ثبت نام کنید</Link>
        </div>
    )
}
