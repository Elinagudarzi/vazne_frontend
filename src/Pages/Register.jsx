...
export const Register = (props) => {
    ...
    return (
        <div className="register-div">
            ...
            <form style={{ marginTop: "-5px" }} className="register-form" onSubmit={handleSubmit}>
            ...
            <Link to="/login" className="link-btn link-btn-hover" >آیا ثبت نام کرده اید؟ وارد شوید</Link>
        </div>
    )
}
